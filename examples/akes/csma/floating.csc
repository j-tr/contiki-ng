...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/akes/csma/plain/plain.c</source>
      <commands>make plain.cooja TARGET=cooja</commands>
    ...
    <mote>
      <interface_config>
        ...
        <x>53.14431135940269</x>
        <y>6.255588398984802</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>39.06688398360975</x>
        <y>16.170953805643844</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>59.21512830751309</x>
        <y>20.8271953451962</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.9919500074775796 0.0 0.0 5.9919500074775796 -113.45045214135256 66.86065687077048</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
